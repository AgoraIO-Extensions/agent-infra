...
export const submitAgentTask = <ThrowOnError extends boolean = false>(options: Options<SubmitAgentTaskData, ThrowOnError>): RequestResult<SubmitAgentTaskResponses, SubmitAgentTaskErrors, ThrowOnError> => (options.client ?? client).post<SubmitAgentTaskResponses, SubmitAgentTaskErrors, ThrowOnError>({
...
export const cancelAgentTask = <ThrowOnError extends boolean = false>(options: Options<CancelAgentTaskData, ThrowOnError>): RequestResult<CancelAgentTaskResponses, CancelAgentTaskErrors, ThrowOnError> => (options.client ?? client).post<CancelAgentTaskResponses, CancelAgentTaskErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
...
export const streamAgentTaskEvents = <ThrowOnError extends boolean = false>(options: Options<StreamAgentTaskEventsData, ThrowOnError, StreamAgentTaskEventsResponse>): Promise<ServerSentEventsResult<StreamAgentTaskEventsResponses>> => (options.client ?? client).sse.get<StreamAgentTaskEventsResponses, StreamAgentTaskEventsErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
