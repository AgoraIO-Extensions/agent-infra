...
export const beginWecomApplicationSetup = <ThrowOnError extends boolean = false>(options: Options<BeginWecomApplicationSetupData, ThrowOnError>): RequestResult<BeginWecomApplicationSetupResponses, BeginWecomApplicationSetupErrors, ThrowOnError> => (options.client ?? client).post<BeginWecomApplicationSetupResponses, BeginWecomApplicationSetupErrors, ThrowOnError>({ url: '/api/v1/agents/{agentId}/wecom-app-setup', ...options });

export const getWecomApplicationSetup = <ThrowOnError extends boolean = false>(options: Options<GetWecomApplicationSetupData, ThrowOnError>): RequestResult<GetWecomApplicationSetupResponses, GetWecomApplicationSetupErrors, ThrowOnError> => (options.client ?? client).get<GetWecomApplicationSetupResponses, GetWecomApplicationSetupErrors, ThrowOnError>({ url: '/api/v1/agents/{agentId}/wecom-app-setup/{sessionId}', ...options });

export const cancelWecomApplicationSetup = <ThrowOnError extends boolean = false>(options: Options<CancelWecomApplicationSetupData, ThrowOnError>): RequestResult<CancelWecomApplicationSetupResponses, CancelWecomApplicationSetupErrors, ThrowOnError> => (options.client ?? client).post<CancelWecomApplicationSetupResponses, CancelWecomApplicationSetupErrors, ThrowOnError>({ url: '/api/v1/agents/{agentId}/wecom-app-setup/{sessionId}/cancel', ...options });

export const submitWecomApplicationCredentials = <ThrowOnError extends boolean = false>(options: Options<SubmitWecomApplicationCredentialsData, ThrowOnError>): RequestResult<SubmitWecomApplicationCredentialsResponses, SubmitWecomApplicationCredentialsErrors, ThrowOnError> => (options.client ?? client).post<SubmitWecomApplicationCredentialsResponses, SubmitWecomApplicationCredentialsErrors, ThrowOnError>({
