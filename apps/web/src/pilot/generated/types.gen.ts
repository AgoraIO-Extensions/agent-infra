...
export type ScopedPlatformAuditProjectionV1 = {
    ...
    taskApi: {
        ...
        phase: 'access' | 'submit.result' | 'subscription.started' | 'subscription.ended';
        reason: 'request_accepted' | 'task_accepted' | 'task_replayed' | 'idempotency_conflict' | 'agent_unavailable' | 'conversation_unavailable' | 'model_unavailable' | 'invalid_request' | 'authentication_required' | 'authorization_revoked' | 'missing_scope' | 'resource_unavailable' | 'capacity_full' | 'conflict' | 'dependency_unavailable' | 'client_disconnected' | 'stream_ended' | 'subscription_unconfirmed';
