...
export const getConnectionAccessPolicyDraft = <ThrowOnError extends boolean = false>(options: Options<GetConnectionAccessPolicyDraftData, ThrowOnError>): RequestResult<GetConnectionAccessPolicyDraftResponses, GetConnectionAccessPolicyDraftErrors, ThrowOnError> => (options.client ?? client).get<GetConnectionAccessPolicyDraftResponses, GetConnectionAccessPolicyDraftErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'connection_session',
            type: 'apiKey'
...
export const updateConnectionAccessPolicy = <ThrowOnError extends boolean = false>(options: Options<UpdateConnectionAccessPolicyData, ThrowOnError>): RequestResult<UpdateConnectionAccessPolicyResponses, UpdateConnectionAccessPolicyErrors, ThrowOnError> => (options.client ?? client).put<UpdateConnectionAccessPolicyResponses, UpdateConnectionAccessPolicyErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'connection_session',
            type: 'apiKey'
